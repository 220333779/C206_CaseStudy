...
public class C206_CaseStudyTest {
	...
	public void testAddUser() {
		...
		// The User just added is as same as the last User in the list
	...
	public void testDeleteUser() {
		...
		//Given a user list with 2 item, after deleting the item, the size of the list is 1.
		...
		//Test that you cannot delete a user that does not exist
		assertEquals("Test that userList size is empty after trying to delete non-existent user"
				, 1, userList.size());
		//Test case 3
		//Delete last user in the list
		assertEquals("Test that the User arraylist size is 1.", 1, userList.size());
		//Given a user list with 1 item, after deleting the item, the size of the list is empty.
		C206_CaseStudy.deleteUser(userList, 98765432);
